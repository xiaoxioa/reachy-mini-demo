            ...
            if _raw_frame is not None:
                try:
                    ...
                    if _head_view is not None and _head_view.person_id is not None:
                        ...
                        _pname = _head_view.person_name      # 焦点名每帧从实时库现取(改名立即跟上)
        ...
        if u_raw is not None:
            ...
            if integrate:
                ...
                with st.lock:
                    ...
                    # 转身找人(glance phase 1/2)是有意动作,放开 fps 冻结,否则 churn 一掉 fps 身体就停转、够不到人
                    if abs(neck_off) > threshold and (_cam_ok or _glance_phase in (1, 2)):
