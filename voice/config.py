...
# ── 级联管线(CascadedPipeline) ──
VOICE_BACKEND = os.environ.get("VOICE_BACKEND", "cascaded")
CASCADE_LLM_MODEL = os.environ.get("CASCADE_LLM_MODEL", "qwen-plus")
CASCADE_TTS_MODEL = os.environ.get("CASCADE_TTS_MODEL", "cosyvoice-v2")
CASCADE_TTS_VOICE = os.environ.get("CASCADE_TTS_VOICE", "longxiaochun")
SILERO_VAD_MODEL = os.path.join(_REPO, "models", "silero_vad.onnx")
SHERPA_ASR_MODEL = os.environ.get("SHERPA_ASR_MODEL",
    os.path.join(_REPO, "models", "sherpa-onnx-paraformer-zh-2024-03-09", "model.onnx"))
SHERPA_ASR_TOKENS = os.environ.get("SHERPA_ASR_TOKENS",
    os.path.join(_REPO, "models", "sherpa-onnx-paraformer-zh-2024-03-09", "tokens.txt"))
CASCADE_ASR_BACKEND = os.environ.get("CASCADE_ASR_BACKEND", "dashscope")
CASCADE_ASR_MODEL = os.environ.get("CASCADE_ASR_MODEL", "paraformer-realtime-v2")
INSTRUCTIONS = (
